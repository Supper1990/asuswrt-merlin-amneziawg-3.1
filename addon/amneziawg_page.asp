    ...
    for(var i = 0; i < lines.length; i++){
        ...
        if(section === 'iface'){
            switch(key){
                ...
                case 'ContentPaddingAddition': setVal('awg_content_padding_addition', val); break;
                case 'RekeyAfterTime': setVal('awg_rekey_after_time', val); break;
                case 'RekeyTimeout': setVal('awg_rekey_timeout', val); break;
                case 'RejectAfterTime': setVal('awg_reject_after_time', val); break;
                ...
                case 'RandomTrailers': setVal('awg_random_trailers', val); break;
                case 'DisableCookies': setVal('awg_disable_cookies', val); break;
    ...
    <td valign="top">
        ...
        <tr>
            ...
            <tr><td bgcolor="#4D595D" valign="top">
                ...
                <tr>
                    <th>Header Protection Key (AWG 3+)</th>
                    <td><input type="password" class="input_32_table" id="awg_header_protection_key" maxlength="64" autocomplete="off" placeholder="Imported from AWG 3.x config"></td>
                </tr>
                <tr>
                    <th>Content Padding Addition</th>
                    <td><input type="text" class="input_20_table" id="awg_content_padding_addition" maxlength="24" placeholder="0-128"></td>
                </tr>
                <tr>
                    <th>Rekey After Time</th>
                    <td><input type="text" class="input_20_table" id="awg_rekey_after_time" maxlength="24" placeholder="seconds or range"></td>
                </tr>
                <tr>
                    <th>Rekey Timeout</th>
                    <td><input type="text" class="input_20_table" id="awg_rekey_timeout" maxlength="24" placeholder="seconds or range"></td>
                </tr>
                <tr>
                    <th>Reject After Time</th>
                    <td><input type="text" class="input_20_table" id="awg_reject_after_time" maxlength="24" placeholder="seconds or range"></td>
                </tr>
                <tr>
                    <th>Keepalive Timeout</th>
                    <td><input type="text" class="input_20_table" id="awg_keepalive_timeout" maxlength="24" placeholder="seconds or range"></td>
                </tr>
                <tr>
                    <th>Max Handshake Attempts</th>
                    <td><input type="text" class="input_20_table" id="awg_max_handshake_attempts" maxlength="24" placeholder="number or range"></td>
                </tr>
                <tr>
                    <th>Random Trailers (AWG 3.1)</th>
                    <td><select id="awg_random_trailers" class="input_option"><option value="">Default</option><option value="on">On</option><option value="off">Off</option></select></td>
                </tr>
                <tr>
                    <th>Disable Cookies (AWG 3.1)</th>
                    <td><select id="awg_disable_cookies" class="input_option"><option value="">Default</option><option value="on">On</option><option value="off">Off</option></select></td>
                </tr>
                <tr>
                    <th>I1 (init junk)</th>
